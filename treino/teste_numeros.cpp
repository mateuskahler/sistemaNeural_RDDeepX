/**
 * Este programa testa uma rede treinada para identificar números
 * 
 * para compilar:
 * 
 ...
 *
 *  O programa procura o sistema neural em um arquivo chamado "sistema_treinado_numeros",
 * como o gerado pelo programa disponível em "treino_numeros.cpp"
 */
...
int main(int, char**)
{
	...
	//mantém apenas classes numéricas (10 primeiras)
		while(amostras_teste.quantidade_classes()>10)
			{ amostras_teste.exclui_classe(10);	}
			
	//carrega sistema neural de arquivo
		sistema_neural_t S;
		if(!S.carrega_de_arquivo(arq_sisN))
		{
